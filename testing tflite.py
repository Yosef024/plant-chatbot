...
interpreter = tf.lite.Interpreter(model_path='plant type lstm full 2 (4).tflite')
...
for i in range(len(val_generator)):
    ...
    # Preprocess the image: ensure it has the correct dtype
    input_data = batch_images.astype(np.float32)
